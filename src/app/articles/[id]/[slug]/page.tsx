...
const ArticleDetail: FC<IArticleDetailProps> = ({}) => {
  // Hooks
    ...
    <Layout>
      ...
      >
        ...
        <section
          ...
          className=" max-w-[1500px] mx-auto flex flex-col items-center gap-y-4 text-center max_md:px-6"
        >
          <h1 className="text-5xl font-black text-tw_primary max_md:text-5xl">
            Le nom de l&apos;article
          </h1>
        ...
        <section className=" max-w-[1500px] mx-auto space-y-10 px-16 max_md:px-6 max_md:text-center">
          <h2 className="text-5xl font-black text-tw_primary max_md:text-3xl">
            Le premier titre de l&apos;article
          </h2>
          ...
          <h2 className="text-5xl font-black text-tw_primary max_md:text-3xl">
            Le deuxième titre de l&apos;article
          </h2>
          <div className="space-y-4 text-justify">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
